  ...
  return (
    <div>
        ...
        <ul>
            ...
            <li>Mercado Envíos es la herramienta tecnológica que ofrecemos para que las Personas Usuarias puedan enviar y recibir sus compras hechas en sitios o aplicaciones que utilicen la tecnología de Mercado Libre.</li>
            <li>También ofrecemos otros servicios como Mercado Shops, Mercado Ads, Mercado Créditos, entre muchos otros, todos con el mismo fin: democratizar el comercio y los servicios financieros en la región. </li>
        </ul>
        ...
        <p>Podrán operar dentro de Mercado Libre quienes tengan capacidad legal y menores de edad debidamente autorizados.</p>
        ...
        <p>En algunos casos, podremos cobrar una tarifa por el uso de los servicios que integran el ecosistema de Mercado Libre, que la Persona Usuaria se compromete a pagar.</p>
        <h3>1. Henry-Merch</h3>
        <p>Mercado Libre es una compañía de tecnología que ofrece servicios vinculados principalmente al comercio electrónico y a los pagos digitales. </p>
        <p>Los servicios que ofrece Mercado Libre en los sitios www.mercadolibre.com.ar y www.mercadopago.com.ar y sus aplicaciones móviles (de ahora en más: “Sitio”) están diseñados para formar un ecosistema que permita a las personas vender, comprar, pagar, enviar productos y realizar otras actividades comerciales con tecnología aplicada (de ahora en más:“Ecosistema MELI”).</p>
        <h3>2. Términos y condiciones</h3>
        <p>Estos términos y condiciones y los anexos que explican los servicios del Ecosistema MELI (de ahora en más: “Términos y Condiciones”) regulan la relación entre Mercado Libre y las  personas que usan sus servicios (“Personas Usuarias”). </p>
        ...
        <p>Cuando debamos hacer cambios importantes en nuestros servicios, publicaremos las modificaciones con 10 días corridos de anticipación para que las Personas Usuarias puedan revisarlas y seguir usando el Ecosistema MELI. El plazo será de 5 días corridos en caso de que tengamos que actualizar las tarifas de nuestros servicios. En ningún caso afectarán las operaciones que ya hayan finalizado.</p>
        <p>Las Personas Usuarias que no tengan obligaciones pendientes con Mercado Libre o con otras Personas Usuarias, podrán finalizar la relación con Mercado Libre cancelando su cuenta.</p>
        <h3>3. Capacidad</h3>
        ...
        <p>Quien use el Ecosistema MELI en representación de una empresa deberá tener capacidad para contratar a nombre de ella. Además, para poder usar la cuenta, la Persona Usuaria debe encontrarse activa. </p>
        ...
        <p>Además, en caso de detectar el uso de más de una cuenta, podremos aplicar retenciones, débitos y/o cualquier otra medida si consideramos que ese accionar puede perjudicar al resto de las personas que usan el Sitio o a Mercado Libre, más allá de las sanciones que pudieran corresponder. </p>
        <h3>5. Privacidad de datos</h3>
        <p>En Mercado Libre hacemos un uso responsable de la información personal, protegiendo la privacidad de las Personas Usuarias que nos confiaron sus datos y tomando las medidas necesarias para garantizar la seguridad en nuestro Ecosistema MELI.</p>
        <h3>6. Sanciones</h3>
        <p>En caso que la Persona Usuaria incumpliera una ley o los Términos y Condiciones, podremos advertir, suspender, restringir o inhabilitar temporal o definitivamente su cuenta, sin perjuicio de otras sanciones que se establezcan en las reglas de uso particulares de los servicios de Mercado Libre.</p>
        <h3>7. Responsabilidad</h3>
        <p>Mercado Libre será responsable por cualquier defecto en la prestación de su servicio, en la medida en que le sea imputable y con el alcance previsto en las leyes vigentes. </p>
        <h3>8. Tarifas</h3>
        <p>Mercado Libre podrá cobrar por sus servicios y la Persona Usuaria se compromete a pagarlos a tiempo.</p>
        ...
        <p>La Persona Usuaria autoriza a Mercado Libre a retener y/o debitar los fondos existentes y/o futuros de su cuenta de Mercado Pago y/o de las cuentas bancarias que haya registrado en ella, para saldar las tarifas impagas o cualquier otra deuda que pudiera tener. </p>
