      ...
      <div className="container bg-white">
        <div className="bg-white ms-5 me-5">
          <div className="text-left">
            ...
            <p>
              Henry's Merch es una compañía de tecnología que ofrece servicios
              vinculados principalmente al comercio electrónico y a los pagos
              digitales.
            </p>
            <ul>
              <li>
                Henry's Merch es una plataforma de comercio electrónico donde
                las Personas Usuarias pueden vender y comprar productos usando
                distintas soluciones de pago y envío.
              </li>
            </ul>
            <p>
              Para poder operar en la plataforma todas las Personas Usuarias
              deberán aceptar los Términos y Condiciones, los anexos y la
              Declaración de Privacidad.
            </p>
            <p>
              Podrán operar dentro de Henry's Merch quienes tengan capacidad
              legal y menores de edad debidamente autorizados.
            </p>
            <p>
              Cada Persona Usuaria es responsable de los datos personales que
              brinda al momento de registrarse y se obliga a mantenerlos
              actualizados. Además, es el único responsable del uso y resguardo
              de su contraseña.{" "}
            </p>
            <p>
              En algunos casos, podremos cobrar una tarifa por el uso de los
              servicios que integran el ecosistema de Henry's Merch, que la
              Persona Usuaria se compromete a pagar.
            </p>
            <h3>1. Henry-Merch</h3>
            <p>
              Henry's Merch es una compañía de tecnología que ofrece servicios
              vinculados a la educación y al comercio electrónico de nuestros
              productos.{" "}
            </p>
            <p>
              Los servicios que ofrece Henry's Merch en sus sitios y
              aplicaciones móviles (de ahora en más: “Sitio”) están diseñados
              para formar un ecosistema que permita a las personas aprender,
              vender, comprar, pagar, enviar productos y realizar otras
              actividades comerciales con tecnología aplicada.
            </p>
            <h3>2. Términos y condiciones</h3>
            <p>
              Estos términos y condiciones y los anexos que explican los
              servicios del Ecosistema (de ahora en más: “Términos y
              Condiciones”) regulan la relación entre Henry's Merch y las
              personas que usan sus servicios (“Personas Usuarias”).{" "}
            </p>
            <p>
              Las Personas Usuarias aceptan estos Términos y Condiciones desde
              el momento en que se registran en el Sitio y usan el Ecosistema.
            </p>
            <p>
              ...
              seguir usando el Ecosistema. El plazo será de 5 días corridos en
              caso de que tengamos que actualizar las tarifas de nuestros
              servicios. En ningún caso afectarán las operaciones que ya hayan
              finalizado.
            </p>
            <p>
              Las Personas Usuarias que no tengan obligaciones pendientes con
              Henry's Merch o con otras Personas Usuarias, podrán finalizar su
              relación con Henry's Merch cancelando su registro.
            </p>
            <h3>3. Capacidad</h3>
            <p>
            ...
            <p>
              ...
              deberá mantener bajo estricta confidencialidad. En caso de
              detectar un uso no autorizado de su cuenta, deberá notificar de
              forma inmediata y fehaciente a Henry's Merch.
            </p>
            <p>
              ...
              Tampoco podrán registrarse quienes estén incluidos o relacionados
              a personas incluidas en listas nacionales o internacionales de
              sanciones.
            </p>
            <h3>5. Privacidad de datos</h3>
            <p>
              En Henry's Merch hacemos un uso responsable de la información
              personal, protegiendo la privacidad de las Personas Usuarias que
              nos confiaron sus datos y tomando las medidas necesarias para
              garantizar la seguridad en nuestro Ecosistema.
            </p>
            <h3>6. Sanciones</h3>
            <p>
              ...
              particulares de los servicios de Henry's Merch.
            </p>
            <h3>7. Responsabilidad</h3>
            <p>
              Henry's Merch será responsable por cualquier defecto en la
              prestación de su servicio, en la medida en que le sea imputable y
              con el alcance previsto en las leyes vigentes.{" "}
            </p>
            <h3>8. Tarifas</h3>
            <p>
              Henry's Merch podrá cobrar por sus servicios y la Persona Usuaria
              se compromete a pagarlos a tiempo.
            </p>
            <p>
            ...
            <p>
              La Persona Usuaria autoriza a Henry's Merch a retener y/o debitar
              los fondos existentes y/o futuros de las cuentas bancarias que
              haya registrado en ella, para saldar las tarifas impagas o
              cualquier otra deuda que pudiera tener.{" "}
            </p>
            <p>
            ...
            <p>
              Henry's Merch y/o sus sociedades relacionadas son propietarias de
              todos los derechos de propiedad intelectual sobre sus sitios, todo
              su contenido, servicios, productos, marcas, nombres comerciales,
              logos, diseños, imágenes, frases publicitarias, derechos de autor,
              dominios, programas de computación, códigos, desarrollos,
              software, bases de datos, información, tecnología, patentes y
            ...
            <p>
              Aunque Henry's Merch otorga permiso para usar sus productos y
              servicios conforme a lo previsto en los Términos y Condiciones,
              esto no implica una autorización para usar su Propiedad
              Intelectual, excepto consentimiento previo y expreso de Henry's
              Merch y/o sus sociedades vinculadas. En cualquier caso, los
              usuarios no podrán utilizar la Propiedad Intelectual de Henry's
              Merch de una manera que cause confusión en el público y deberán
              llevar a cabo su actividad comercial bajo una marca o nombre
              comercial propio y distintivo, que no resulte confundible con la
              marca Henry's Merch.
            </p>
            <p>
              ...
              derivadas, utilizar herramientas de búsqueda o de extracción de
              datos y contenidos de nuestra plataforma para su reutilización y/o
              crear bases de datos propias que incluyan en todo o en parte
              ...
              Henry's Merch y/o a sus sociedades relacionadas. La utilización de
              los productos y servicios de Henry's Merch tampoco implica la
              autorización para usar propiedad intelectual de terceros que pueda
              estar involucrada, cuyo uso quedará bajo exclusiva responsabilidad
              del usuario.{" "}
            </p>
            <h3>10. Indemnidad</h3>
            ...
            <p>
              ...
              ejemplo, legislación relativa al Consumidor.
            </p>
          </div>
