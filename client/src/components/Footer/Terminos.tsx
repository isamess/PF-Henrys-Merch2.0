...
export const Terminos = () => {
  return (
    <div className= "ms-5 mt-3">
        ...
        <p>Henry's Merch es una compañía de educación en tecnología que ofrece servicios vinculados principalmente a la formación tecnológica latinoamericana.</p>
        <ul className= "list-unstyled">
            <li>Nuestro Market es una plataforma de comercio electrónico de nuestros productos de difusión de nuestras carreras .</li>
        </ul>
        ...
        <p>Podrán operar dentro de Henry's Merch quienes tengan capacidad legal y menores de edad debidamente autorizados.</p>
        ...
        <h3>1. Henry-Merch</h3>
        <p>Henry's Merch es una compañía de tecnología que ofrece servicios vinculados principalmente a la educación en tecnología</p>
        <h3>2. Términos y condiciones</h3>
        <p>Estos términos y condiciones y los anexos que explican los servicios del Ecosistema (de ahora en más: “Términos y Condiciones”) regulan la relación entre Henry's Merch y las  personas que usan sus servicios (“Personas Usuarias”). </p>
        <p>Las Personas Usuarias aceptan estos Términos y Condiciones desde el momento en que se registran en el Sitio y usan el Ecosistema.</p>
        <p>Cuando debamos hacer cambios importantes en nuestros servicios, publicaremos las modificaciones con 10 días corridos de anticipación para que las Personas Usuarias puedan revisarlas y seguir usando el Ecosistema de Henry's Merch. El plazo será de 5 días corridos en caso de que tengamos que actualizar las tarifas de nuestros servicios. En ningún caso afectarán las operaciones que ya hayan finalizado.</p>
        <h3>3. Capacidad</h3>
        ...
        <p>En Henry's Merch hacemos un uso responsable de la información personal, protegiendo la privacidad de las Personas Usuarias que nos confiaron sus datos y tomando las medidas necesarias para garantizar la seguridad en nuestro Ecosistema MELI.</p>
        <h3>6. Sanciones</h3>
        <p>En caso que la Persona Usuaria incumpliera una ley o los Términos y Condiciones, podremos advertir, suspender, restringir o inhabilitar temporal o definitivamente su cuenta, sin perjuicio de otras sanciones que se establezcan en las reglas de uso particulares de los servicios de Henry's Merch.</p>
        <h3>7. Responsabilidad</h3>
        <p>Henry's Merch será responsable por cualquier defecto en la prestación de su servicio, en la medida en que le sea imputable y con el alcance previsto en las leyes vigentes. </p>
        <h3>8. Tarifas</h3>
        ...
        <p>Henry's Merch y/o sus sociedades relacionadas son propietarias de todos los derechos de propiedad intelectual sobre sus sitios, todo su contenido, servicios, productos, marcas, nombres comerciales, logos, diseños, imágenes, frases publicitarias, derechos de autor, dominios, programas de computación, códigos, desarrollos, software, bases de datos, información, tecnología, patentes y modelos de utilidad, diseños y modelos industriales, secretos comerciales, entre otros (“Propiedad Intelectual”) y se encuentran protegidos por leyes nacionales e internacionales.</p>
        <p>Aunque Henry's Merch otorga permiso para usar sus productos y servicios conforme a lo previsto en los Términos y Condiciones, esto no implica una autorización para usar su  Propiedad Intelectual, excepto consentimiento previo y expreso de Henry's Merch y/o sus sociedades vinculadas. En cualquier caso, los usuarios vendedores que usen dichos productos y servicios no podrán utilizar la Propiedad Intelectual de Henry's Merch de una manera que cause confusión en el público y deberán llevar a cabo su actividad comercial bajo una marca o nombre comercial propio y distintivo, que no resulte confundible con la marca Henry's Merch, Henry y SoyHenry.</p>
        <p>Está prohibido usar nuestros productos o servicios para fines ilegales, realizar cualquier tipo de ingeniería inversa u obras derivadas, utilizar herramientas de búsqueda o de extracción de datos y contenidos de nuestra plataforma para su reutilización y/o crear bases de datos propias que incluyan en todo o en parte nuestro contenido sin nuestra expresa autorización. Está también prohibido el uso indebido, sin autorización y/o contrario a la normativa vigente y/o que genere confusión o implique uso denigratorio y/o que le cause perjuicio, daños o pérdidas a Henry's Merch y/o a sus sociedades relacionadas. La utilización de los productos y servicios de Henry's Merch tampoco implica la autorización para usar propiedad intelectual de terceros que pueda estar involucrada, cuyo uso quedará bajo exclusiva responsabilidad del usuario. </p>
        <p>En caso que una Persona Usuaria o cualquier publicación infrinja la Propiedad Intelectual de Henry's Merch o de terceros, Henry's Merch podrá remover dicha publicación total o parcialmente), sancionar al usuario conforme a lo previsto en estos Términos y Condiciones y ejercer las acciones extrajudiciales y/o judiciales correspondientes.</p>
        <h3>10. Indemnidad</h3>
        <p>La Persona Usuaria mantendrá indemne a Henry's Merch y sus sociedades relacionadas, así como a quienes la dirigen, suceden, administran, representan y/o trabajan en ellas, por cualquier reclamo administrativo o judicial iniciado por otras Personas Usuarias, terceros o por cualquier Organismo, relacionado con sus actividades en el Ecosistema.</p>
